...
namespace core::meta 
{
	constdata bool Settings<bitwise_enum, core::forms::LinkStyle> = true;
	constdata bool Settings<compatible_enum, core::forms::LinkStyle, core::forms::WindowStyle> = true;
	constdata bool Settings<compatible_enum, core::forms::WindowStyle, core::forms::LinkStyle> = true;
}
