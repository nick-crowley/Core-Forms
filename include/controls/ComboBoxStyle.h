...
namespace core::meta 
{
	constdata bool Settings<bitwise_enum, core::forms::ComboBoxStyle> = true;
	constdata bool Settings<compatible_enum, core::forms::ComboBoxStyle, core::forms::WindowStyle> = true;
	constdata bool Settings<compatible_enum, core::forms::WindowStyle, core::forms::ComboBoxStyle> = true;
}
