...
namespace core::forms
{
    ...
    PenStyle constexpr inline operator|(PenStyle a, PenStyle b) { return detail::enum_bit_or(a,b);  }
    PenStyle constexpr inline operator&(PenStyle a, PenStyle b) { return detail::enum_bit_and(a,b); }
    PenStyle constexpr inline operator^(PenStyle a, PenStyle b) { return detail::enum_bit_xor(a,b); }
}